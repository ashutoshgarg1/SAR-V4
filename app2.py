                        ...
                        # File handling logic
                            ...
                            if st.session_state.llm == "Closed-Source":
                                ...
                                prompt = f" You are professional Fraud Analyst. Find answer to the questions as truthfully and in as detailed as possible as per given context only,\n\n\
                                    ...
                                    Context: {contexts}\n\
                                    Response (Start the output answering if it is a suspicious activity or not and then Give me a concise recommendation in few pointers.If not a case of suspicion them mention it properly.)"
