                    ...
                    if st.session_state.clicked1:
                        if temp_file_path2 is not None:
                            ...
                            if st.session_state.llm == "Closed-Source":
                                ...
                                Transactions made to a suspicious entity. Output "Description", "Date" and "Debited ($)" of each identified transactions in the provided format.\n\
                                Format : "Description:  Date:  Debited ($):" . # Strictly do not repeat any transaction.\n\
                                Context: {context_1}\n\
